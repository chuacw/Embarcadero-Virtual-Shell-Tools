...
uses SysUtils, Windows, Classes,
  ...
  Consts
  {$endif},
  ActiveX, ShellAPI, ShlObj, Graphics, IDEVirtualResources, IDEVirtualUtilities,
...
begin
  ...
  begin
    ...
    begin
      ...
      if GetDiskFreeSpaceExA_VST(PAnsiChar(S), FreeSpaceAvailable, TotalSpace, nil) then
        Result := TotalSpace - FreeSpaceAvailable;
    end else
    begin

...
uses
  ...
  Buttons, IDEVirtualShellUtilities, IDEVirtualWideStrings, ShellAPI, CommCtrl, ShlObj, ActiveX,
  Imglist, IDEVirtualExplorerTree, ActnList, ToolWin, IDEVirtualDataObject, IDEVirtualPIDLTools,
  IDEVirtualUtilities, IDEVirtualShellTypes, IDEVirtualResources, IDEVirtualUnicodeDefines,
  IDEVirtualSystemImageLists,
  {$IFDEF SHELLNOTIFIER} IDEVirtualShellNotifier, {$ENDIF}
